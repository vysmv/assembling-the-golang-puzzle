...
Первым делом выполняется проверка наличия аргумента командной строки, то есть
...
Все это реализовано как структура состояния, функция для создания значения и три метода:
...
Важно, что render.go отвечает только за внешний вид отображаемых данных.
