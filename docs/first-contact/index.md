...
Итак, на этом месте я хочу немного остановиться и зафиксировать то, что у нас получилось.

Если убрать все детали, команды и частные случаи, то Go в плане модулей и импортов строится вокруг очень простой идеи.
...
Тем не менее, если данное видео показалось вам интересным, то не забывайте ставить лайк и подписываться.  
