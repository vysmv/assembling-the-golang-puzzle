# Notice: Как завершать программу на Go: return, panic и os.Exit
...
В этом видео я разберу вопрос о том, как в Go обстоят дела в вопросе завершения программ.  
...
> Дополнительно
> 
> Конечно процесс может завершится и из за внешнего сигнала ОС или из за ошибки в рантайме или из за использования runtime.Goexit() но я не буду разбирать эти ситуации. По тому что они не нужны в контексте этого видео.  
